...
use crate::{store::slice::ConfigSlice, types::chat::Role};
...
#[function_component]
pub fn Message(MessageProps { role, content, message_index, sticky }: &MessageProps) -> Html {
...
#[function_component]
fn MessageContent(MsgContentProps { role, content, message_index, sticky }: &MsgContentProps) -> Html {
